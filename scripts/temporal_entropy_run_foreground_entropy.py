...
at a given point in time. Here, the entropy is only calculated for the 
foreground signal, where the response distribution is over backgrounds.

Created by Nirag Kadakia at 22:26 06-06-2019
